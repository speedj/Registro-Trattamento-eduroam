...
# e. Categorie di destinatari (trasferimento)
## IdP
...
Servizio ridondato su due server. Configurazione principale backuppata.
...
Da pubblicare, ma impossibile avere un consenso esplicito o da somministrare al primo accesso o prima di esso.

## Dati di cntatto
vedi Registro del trattamento lettera a
 in caso di utenti di questa organizzazione.

## Finalità del trattamento 
vedi Registro del trattamento lettera b
Eventuale base giuridica del trattamento.
...
Perseguire il buon funzionamento del servizio per tutto e soli gli interessati aventi diritto, effettuare statistiche d'uso su base aggregata del servizio per lo stesso fine.
...
- opporsi al trattamento (obiezione pertinente e motivata)
